...
chrom_file = 'debug_png_id_580.txt.gz'
...
def main():
    ...
    display_data, peak_group_candidates, chrom_data = chrom.compute_reference_sample_peak_boundary(ref_sample_data, chrom_data, peptide_data, peak_group_candidates)
